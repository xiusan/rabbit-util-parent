package com.unioncloud.xjl.producer.task;
...
import com.unioncloud.xjl.producer.broker.RabbitBroker;
import com.unioncloud.xjl.producer.constant.BrokerMessageStatus;
import com.unioncloud.xjl.producer.entity.BrokerMessage;
import com.unioncloud.xjl.producer.service.MessageStoreService;
import com.unioncloud.xjl.task.annotation.ElasticJobConfig;
...
@Component
@ElasticJobConfig(
		name= "com.unioncloud.xjl.producer.task.RetryMessageDataflowJob",
		cron= "0/10 * * * * ?",
